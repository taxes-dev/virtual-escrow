...
#ifndef PROTOBUF_protos_2fecho_2eproto__INCLUDED
#define PROTOBUF_protos_2fecho_2eproto__INCLUDED
...
class EchoRequest : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:escrow.EchoRequest)
 private:
  ...
  ::std::string* message_;
  friend void  protobuf_AddDesc_protos_2fecho_2eproto();
  friend void protobuf_AssignDesc_protos_2fecho_2eproto();
  friend void protobuf_ShutdownFile_protos_2fecho_2eproto();
...
class EchoResponse : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:escrow.EchoResponse)
 private:
  inline void set_has_message();
  inline void clear_has_message();
...
inline const ::std::string& EchoRequest::message() const {
  // @@protoc_insertion_point(field_get:escrow.EchoRequest.message)
  return *message_;
}
inline void EchoRequest::set_message(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:escrow.EchoRequest.message)
}
inline void EchoRequest::set_message(const char* value) {
  ...
  message_->assign(value);
  // @@protoc_insertion_point(field_set_char:escrow.EchoRequest.message)
}
inline void EchoRequest::set_message(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:escrow.EchoRequest.message)
}
inline ::std::string* EchoRequest::mutable_message() {
  ...
  // @@protoc_insertion_point(field_mutable:escrow.EchoRequest.message)
  return message_;
}
...
inline void EchoRequest::set_allocated_message(::std::string* message) {
  ...
  // @@protoc_insertion_point(field_set_allocated:escrow.EchoRequest.message)
}
...
inline const ::std::string& EchoResponse::message() const {
  // @@protoc_insertion_point(field_get:escrow.EchoResponse.message)
  return *message_;
}
inline void EchoResponse::set_message(const ::std::string& value) {
  ...
  message_->assign(value);
  // @@protoc_insertion_point(field_set:escrow.EchoResponse.message)
}
inline void EchoResponse::set_message(const char* value) {
  ...
  message_->assign(value);
  // @@protoc_insertion_point(field_set_char:escrow.EchoResponse.message)
}
inline void EchoResponse::set_message(const char* value, size_t size) {
  ...
  message_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:escrow.EchoResponse.message)
}
inline ::std::string* EchoResponse::mutable_message() {
  ...
  // @@protoc_insertion_point(field_mutable:escrow.EchoResponse.message)
  return message_;
}
...
inline void EchoResponse::set_allocated_message(::std::string* message) {
  ...
  // @@protoc_insertion_point(field_set_allocated:escrow.EchoResponse.message)
}
...
#endif  // PROTOBUF_protos_2fecho_2eproto__INCLUDED
